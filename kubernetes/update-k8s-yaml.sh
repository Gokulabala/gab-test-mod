...
if [[ "$GITHUB_REF" == "refs/heads/main" ]]; then
    ECR_IMAGE="$AWS_ACCOUNT_ID.dkr.ecr.eu-north-1.amazonaws.com/gabapprepoprod:latest"
    echo "Deploying to production environment..."
else
    ECR_IMAGE="$AWS_ACCOUNT_ID.dkr.ecr.eu-north-1.amazonaws.com/gabapprepodev:latest"
